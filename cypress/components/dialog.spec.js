...
describe('Dialog tests', () => {
    ...
    it('onClose test', () => {
        ...
        mount(
            <Dialog id={'dialog'} open={true} onClose={handleClose}>
                {' '}
                Test{' '}
            </Dialog>
        );
    ...
    it('fullScreen test', () => {
        mount(
            <Dialog id={'dialog'} open={true} fullScreen={false}>
                {' '}
                Test{' '}
            </Dialog>
        );
        ...
        mount(
            <Dialog id={'dialog'} open={true} fullScreen={true}>
                {' '}
                Test{' '}
            </Dialog>
        );
    ...
    it('hide close button test', () => {
        mount(
            <Dialog id={'dialog'} open={true} hideCloseButton={false}>
                {' '}
                Test{' '}
            </Dialog>
        );
        ...
        mount(
            <Dialog id={'dialog'} open={true} hideCloseButton={true}>
                {' '}
                Test{' '}
            </Dialog>
        );
    ...
    it('draggable test', () => {
        mount(
            <Dialog id={'dialog'} open={true} draggable={false}>
                {' '}
                Test{' '}
            </Dialog>
        );
        ...
        mount(
            <Dialog id={'dialog'} open={true} draggable={true}>
                {' '}
                Test{' '}
            </Dialog>
        );
