...
const messages = {
    tr: {
        ...
        FILE_INPUT_MAX_FILE_SIZE_MESSAGE: 'En fazla {{maxFileBytes}} byte boyutunde dosya yükleyebilirsiniz',
    ...
    en: {
        ...
        FILE_INPUT_MAX_FILE_SIZE_MESSAGE: 'You can upload files up to {{maxFileBytes}} bytes.',
    ...
    ar: {
        ...
        FILE_INPUT_MAX_FILE_SIZE_MESSAGE: 'يمكنك تحميل ملفات يصل حجمها إلى {{maxFileBytes}} بايت.',
