...
const CurrentRulesInfo = ({ currentRules, header = 'Current Rules', dontStringify = false }) => {
    return (
        <div className={'currentRuleInfoDiv'}>
            <Accordion>
                ...
                <AccordionDetails>
                    <span className={'currentRuleString'}>
                        {dontStringify ? currentRules : stringifyWithFunction(currentRules)}
                    </span>
                </AccordionDetails>
            </Accordion>
        </div>
